...
var AppCache = (function () {
  ...
  _createClass(AppCache, [{
    ...
    value: function getManifestTemplate(cache, plugin) {
      ...
      var thisFALLBACK = this.FALLBACK;
      ...
      if (plugin.appShell) {
        ...
        thisFALLBACK = (0, _deepExtend3['default'])(_defineProperty({}, this.pathRewrite(scope), plugin.appShell), this.FALLBACK || {});
      }

      if (thisFALLBACK) {
        FALLBACK = 'FALLBACK:\n' + Object.keys(thisFALLBACK).map(function (path) {
