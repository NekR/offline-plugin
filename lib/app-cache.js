...
var AppCache = function () {
  function AppCache(options) {
    ...
    if ((0, _utils.isAbsolutePath)(output)) {
  ...
  _createClass(AppCache, [{
    ...
    value: function apply(plugin, compilation, compiler) {
      ...
      compilation.assets[path + '.appcache'] = (0, _utils.getSource)(manifest);
      compilation.assets[path + '.html'] = (0, _utils.getSource)(page);
    }
  }, {
    ...
    value: function getManifestTemplate(cache, plugin) {
      ...
      if (!this.includeCrossOrigin) {
        cache = cache.filter(function (asset) {
          if ((0, _utils.isAbsoluteURL)(asset) && (_this.basePath === '/' || asset.indexOf(_this.basePath) !== 0)) {
            return false;
          }
