...
var ServiceWorker = function () {
  function ServiceWorker(options) {
    ...
    if ((0, _utils.isAbsolutePath)(options.output)) {
  ...
  _createClass(ServiceWorker, [{
    ...
    value: function addEntry(plugin, compilation, compiler) {
      ...
      childCompiler.apply(new _SingleEntryPlugin2.default(compiler.context, entry, name));
    ...
    value: function apply(plugin, compilation, compiler) {
      ...
      compilation.assets[this.output] = (0, _utils.getSource)(source);
    }
  }, {
    key: 'getDataTemplate',
