  ...
  _createClass(ServiceWorker, [{
    ...
    value: function addEntry(plugin, compilation, compiler) {
      ...
      if (this.minify === true) {
        ...
        childCompiler.apply(new _uglifyjsWebpackPlugin2['default'](options));
      } else if (this.minify !== false) {
        (compiler.options.plugins || []).some(function (plugin) {
          if (plugin instanceof _uglifyjsWebpackPlugin2['default']) {
    ...
    value: function apply(plugin, compilation, compiler) {
      ...
      if (typeof this.minify === 'boolean') {
        ...
        minify = !!(compiler.options.plugins || []).some(function (plugin) {
          return plugin instanceof _uglifyjsWebpackPlugin2['default'];
        });
      }
