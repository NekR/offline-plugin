    ...
    value: function setAssets(assets, compilation) {
      ...
      if (Array.isArray(alwaysRevalidate) && alwaysRevalidate.length) {
        alwaysRevalidate = assets.filter(function (asset) {
          ...
          try {
            for (var _iterator2 = alwaysRevalidate[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      if (Array.isArray(ignoreSearch) && ignoreSearch.length) {
        ignoreSearch = assets.filter(function (asset) {
          ...
          try {
            for (var _iterator3 = ignoreSearch[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      if (Array.isArray(preferOnline) && preferOnline.length) {
        preferOnline = assets.filter(function (asset) {
          ...
          try {
            for (var _iterator4 = preferOnline[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          var handledCaches = ['main', 'additional', 'optional'].reduce(function (result, key) {
            ...
            cache.some(function (cacheKey) {
              ...
              externalsCheck: if (index === -1) {
                ...
                try {
                  for (var _iterator5 = _this3.externals[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    var glob = _step5.value;
