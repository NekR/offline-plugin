...
var _require = require('../package.json'),
    pluginVersion = _require.version;
...
var defaultOptions = {
  ...
  rewrites(asset) {
    return asset.replace(/^([\s\S]*?)index.htm(l?)$/, function (match, dir) {
      if ((0, _utils.isAbsoluteURL)(match)) {
        return match;
      }
  ...
  _createClass(OfflinePlugin, [{
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('normal-module-factory', function (nmf) {
        nmf.plugin('after-resolve', function (result, callback) {
          ...
          var data = {
            autoUpdate: _this2.options.autoUpdate,
            autoUpdateInterval: _this2.options.autoUpdateInterval
          };
    ...
    value: function setAssets(compilation) {
      ...
      if (caches === 'all') {
        ...
        (function () {
          var restSection = void 0;
          var externalsSection = void 0;
          ...
          var handledCaches = ['main', 'additional', 'optional'].reduce(function (result, key) {
            ...
            cache.some(function (cacheKey) {
              ...
              if (!(0, _utils.isAbsoluteURL)(cacheKey) && cacheKey[0] !== '/' && cacheKey.indexOf('./') !== 0 && (magic = (0, _utils.hasMagic)(cacheKey))) {
                var matched = void 0;
    ...
    value: function resolveToolPaths(tool, key, compiler) {
      ...
      if (this.relativePaths) {
        tool.pathRewrite = function (_path) {
          if ((0, _utils.isAbsoluteURL)(_path) || _path[0] === '/') {
            return _path;
          }
    ...
    get: function get() {
      ...
      return (0, _utils.interpolateString)(version, { hash });
    }
  }]);
