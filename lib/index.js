    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('emit', function (compilation, callback) {
        if (!_this2.flags.runtimeAdded && !_this2.__tests.ignoreRuntime) {
          callback(new Error('offline-plugin: Plugin\'s runtime wasn\'t added to one of your bundle entries. See this https://goo.gl/YwewYp for details.'));
          return;
        }
        ...
        try {
          ...
          // Probably generate bundle hash manually (from what we have)
