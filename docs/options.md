...
Excludes matched assets from being added to the [caches](https://github.com/NekR/offline-plugin#caches-all--object). Exclusion is performed before [_rewrites_](https://github.com/lcxfs1991/offline-plugin/blob/master/docs/options.md#rewrites-function--object) happens.  
